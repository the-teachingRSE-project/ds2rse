...
- **Research Data Managers** (also known as Data Stewards) are responsible for overseeing the lifecycle of research data, from its creation and collection to its storage, sharing, and preservation [@zenodo4915861].
  ...
  improve the handling of research data at every point in the data cycle.
  ...
  Within Germany, numerous regional data management networks have been formed. More information can be found at [@fdminfo].
