...
We compared research software engineering and data science through the lens of the research cycle, examining how each discipline contributes at various stages.
...
We have given a short and non-exhaustive introduction into the profiles of the RSE, the Data Scientist, and the Research Data Manager.
We have sketched their historical Development in order to enable practitioners from the other field participate in the discussion.
The research cycle has served us as a useful backdrop on which to compare data science and research software engineering.
